...
function updateDom() {
	function renderDom(data) {
		...
		`<div class="gasprice js-gasprice" data-option="slow">
			...
			<span class="gasprice-USD">${escapeHtml(data.gasData.slow.USD)}</span>
		</div>`+
		`<div class="gasprice js-gasprice" data-option="standard">
			...
			<span class="gasprice-USD">${escapeHtml(data.gasData.standard.USD)}</span>
		</div>`+
		`<div class="gasprice js-gasprice" data-option="fast">
			...
			<span class="gasprice-USD">${escapeHtml(data.gasData.fast.USD)}</span>
		</div>`+
		`<div class="gasprice js-gasprice" data-option="rapid">
			...
			<span class="gasprice-USD">${escapeHtml(data.gasData.rapid.USD)}</span>
		</div>`;
